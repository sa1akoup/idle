...
import { useCharacterLoadout, type CharacterEmit, type CharacterProps } from '../composables/useCharacterLoadout'
      ...
      <div class="loadout-area">
        ...
        <div class="loadout-block">
          ...
          <div v-if="activePresetWeapon?.ammoPerRound" class="preset-name-row">
            <el-select v-model="presets[presetIndex].ammoId" placeholder="选择兼容弹药">
              <el-option
            ...
            />
            <small>失能恢复时优先取仓库中的预设弹药；不足一次攻击时，自动购买当时可用的最高等级弹药</small>
          </div>
          <div class="consumable-block">
