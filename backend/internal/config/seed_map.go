...
func seedMap(db *gorm.DB) error {
	return db.Transaction(func(tx *gorm.DB) error {
		...
		nodes := []models.NodeDef{
			{ID: "city_ruins_node_1", MapID: gameMap.ID, Name: "码头北区", PositionX: 0, PositionY: 0, ExploreTime: 3, Distance: "far", EnemyID: "template_patrol", EncounterRole: "patrol", ContainerSlots: 2, ValueTier: 2, EncounterChance: 50, Tags: []string{"outdoor", "waterfront", "extraction_anchor"}},
			...
			{ID: "city_ruins_node_4", MapID: gameMap.ID, Name: "地下通道", PositionX: 0, PositionY: 1, ExploreTime: 4, Distance: "close", EnemyID: "template_patrol", EncounterRole: "patrol", ContainerSlots: 2, ValueTier: 2, EncounterChance: 55, Tags: []string{"underground", "enclosed", "medical"}},
