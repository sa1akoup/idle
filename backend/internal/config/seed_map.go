...
func seedMap(db *gorm.DB) error {
	return db.Transaction(func(tx *gorm.DB) error {
		...
		nodes := []models.NodeDef{
			{ID: "city_ruins_node_1", MapID: gameMap.ID, Name: "码头北区", PositionX: 0, PositionY: 0, ExploreTime: 3, Distance: "far", EnemyID: "template_patrol", EncounterRole: "patrol", ContainerSlots: 3, ValueTier: 2, EncounterChance: 45, Tags: []string{"outdoor", "waterfront", "extraction_anchor"}},
			{ID: "city_ruins_node_2", MapID: gameMap.ID, Name: "废弃仓库", PositionX: 1, PositionY: 0, ExploreTime: 4, Distance: "mid", EnemyID: "template_guard", EncounterRole: "guard", ContainerSlots: 4, ValueTier: 3, EncounterChance: 55, Tags: []string{"industrial", "indoor", "warehouse", "material"}},
			{ID: "city_ruins_node_3", MapID: gameMap.ID, Name: "旧市场", PositionX: 2, PositionY: 0, ExploreTime: 3, Distance: "mid", EnemyID: "template_patrol", EncounterRole: "patrol", ContainerSlots: 3, ValueTier: 2, EncounterChance: 45, Tags: []string{"outdoor", "market", "supply"}},
			{ID: "city_ruins_node_4", MapID: gameMap.ID, Name: "地下通道", PositionX: 0, PositionY: 1, ExploreTime: 4, Distance: "close", EnemyID: "template_patrol", EncounterRole: "patrol", ContainerSlots: 3, ValueTier: 2, EncounterChance: 50, Tags: []string{"underground", "enclosed", "medical"}},
			{ID: "city_ruins_node_5", MapID: gameMap.ID, Name: "居民楼", PositionX: 1, PositionY: 1, ExploreTime: 3, Distance: "close", EnemyID: "template_patrol", EncounterRole: "patrol", ContainerSlots: 3, ValueTier: 1, EncounterChance: 35, Tags: []string{"residential", "indoor", "food", "spawn"}},
			{ID: "city_ruins_node_6", MapID: gameMap.ID, Name: "集装箱场", PositionX: 2, PositionY: 1, ExploreTime: 4, Distance: "mid", EnemyID: "template_guard", EncounterRole: "guard", ContainerSlots: 5, ValueTier: 3, EncounterChance: 55, Tags: []string{"industrial", "outdoor", "cargo", "material"}},
			{ID: "city_ruins_node_7", MapID: gameMap.ID, Name: "社区诊所", PositionX: 0, PositionY: 2, ExploreTime: 3, Distance: "close", EnemyID: "template_patrol", EncounterRole: "patrol", ContainerSlots: 3, ValueTier: 3, EncounterChance: 50, Tags: []string{"indoor", "medical", "safehouse"}},
			{ID: "city_ruins_node_8", MapID: gameMap.ID, Name: "海关办公楼", PositionX: 1, PositionY: 2, ExploreTime: 5, Distance: "close", EnemyID: "template_elite", EncounterRole: "elite", ContainerSlots: 4, ValueTier: 5, EncounterChance: 70, Tags: []string{"indoor", "intel", "secured", "high_value"}},
			{ID: "city_ruins_node_9", MapID: gameMap.ID, Name: "加油站", PositionX: 2, PositionY: 2, ExploreTime: 3, Distance: "far", EnemyID: "template_guard", EncounterRole: "guard", ContainerSlots: 3, ValueTier: 4, EncounterChance: 65, Tags: []string{"outdoor", "fuel", "extraction_anchor"}},
		}
