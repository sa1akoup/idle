...
func seedLoot(db *gorm.DB) error {
	items := []models.LootItemDef{
		...
		{ID: "pipe_grip_wrench", Name: "管钳", Category: "tool", Desc: "用于固定管路接头的管钳。", Price: 260, Weight: 2, Slots: 1, MerchantCategory: "mechanical"},
		...
		{ID: "pack_of_screws", Name: "一包螺丝", Category: "material", Desc: "一包工业设备维修螺丝。", Price: 70, Weight: 1, Slots: 1, MerchantCategory: "mechanical"},
		...
		{ID: "poxeram", Name: "Poxeram 冷焊胶", Category: "material", Desc: "用于修补金属部件的冷焊胶。", Price: 170, Weight: 1, Slots: 1, MerchantCategory: "mechanical"},
		{ID: "xenomorph_foam", Name: "Xenomorph 密封泡沫", Category: "material", Desc: "用于填充和密封结构缝隙的泡沫材料。", Price: 220, Weight: 1, Slots: 1, MerchantCategory: "mechanical"},
		{ID: "fleece_fabric", Name: "抓绒布", Category: "material", Desc: "耐磨的合成抓绒布料。", Price: 120, Weight: 1, Slots: 1, MerchantCategory: "mechanical"},
		...
		{ID: "t_shaped_plug", Name: "T 形插头", Category: "electronics", Desc: "用于扩展电路连接的 T 形插头。", Price: 90, Weight: 1, Slots: 1, MerchantCategory: "mechanical"},
		{ID: "vpx_flash_storage_module", Name: "VPX 闪存模块", Category: "electronics", Desc: "军用计算设备的高速闪存模块。", Price: 1250, Weight: 1, Slots: 1, MerchantCategory: "union"},
		{ID: "military_power_filter", Name: "军用电源滤波器", Category: "electronics", Desc: "用于稳定军用设备电源的滤波器。", Price: 1000, Weight: 1, Slots: 1, MerchantCategory: "union"},
		{ID: "phase_control_relay", Name: "相位控制继电器", Category: "electronics", Desc: "工业电力控制设备中的继电器。", Price: 650, Weight: 1, Slots: 1, MerchantCategory: "union"},
		{ID: "electric_motor", Name: "电动机", Category: "electronics", Desc: "用于驱动工业设备的电动机。", Price: 480, Weight: 2, Slots: 1, MerchantCategory: "mechanical"},
		{ID: "bundle_of_wires", Name: "一捆电线", Category: "electronics", Desc: "捆扎好的多芯电线。", Price: 140, Weight: 1, Slots: 1, MerchantCategory: "mechanical"},
		{ID: "energy_saving_lamp", Name: "节能灯", Category: "electronics", Desc: "用于照明设施的节能灯泡。", Price: 100, Weight: 1, Slots: 1, MerchantCategory: "mechanical"},
		{ID: "light_bulb", Name: "灯泡", Category: "electronics", Desc: "通用规格的照明灯泡。", Price: 45, Weight: 1, Slots: 1, MerchantCategory: "mechanical"},
		{ID: "wi_fi_camera", Name: "Wi-Fi 摄像头", Category: "electronics", Desc: "可接入网络的监控摄像头。", Price: 380, Weight: 1, Slots: 1, MerchantCategory: "mechanical"},
		{ID: "radiator_helix", Name: "散热器螺旋管", Category: "electronics", Desc: "工业散热系统使用的螺旋管。", Price: 360, Weight: 1, Slots: 1, MerchantCategory: "mechanical"},
		...
		{ID: "moonshine", Name: "烈酒月光酒", Category: "food", Desc: "高纯度自酿烈酒。", Price: 1200, Weight: 1, Slots: 1, MerchantCategory: "medical"},
		...
		{ID: "chainlet", Name: "Chainlet 项链", Category: "valuable", Desc: "带有 Chainlet 标识的金属项链。", Price: 1350, Weight: 1, Slots: 1, MerchantCategory: "black"},
		{ID: "lucky_scav_junk_box", Name: "幸运 Scav 杂物箱", Category: "valuable", Desc: "用于收纳 Scav 杂物的特制箱子。", Price: 5500, Weight: 6, Slots: 4, MerchantCategory: "black"},
