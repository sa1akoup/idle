...
func seedEnemyTemplates(db *gorm.DB) error {
	templates := []models.EnemyTemplateDef{
		// ---- 杂鱼 (grunt) ----
		{
			...
			IntellectBase: 30, IntellectFlux: 6, ResistBase: 35, ResistFlux: 6,
		...
		},
		{
			...
			IntellectBase: 35, IntellectFlux: 6, ResistBase: 40, ResistFlux: 6,
		...
		// ---- 守卫 (guard) ----
		{
			...
			IntellectBase: 40, IntellectFlux: 6, ResistBase: 45, ResistFlux: 6,
		...
		},
		{
			...
			IntellectBase: 45, IntellectFlux: 6, ResistBase: 50, ResistFlux: 8,
		...
		// ---- 精锐 (elite) ----
		{
			...
			IntellectBase: 50, IntellectFlux: 6, ResistBase: 50, ResistFlux: 8,
		...
		},
		{
			...
			IntellectBase: 50, IntellectFlux: 6, ResistBase: 55, ResistFlux: 8,
		...
		// ---- 狙击 (sniper) ----
		{
			...
			IntellectBase: 45, IntellectFlux: 6, ResistBase: 45, ResistFlux: 6,
		...
		// ---- 邪教徒 (elite/近战) ----
		{
			...
			IntellectBase: 55, IntellectFlux: 6, ResistBase: 60, ResistFlux: 8,
		...
		// ---- BOSS ----
		{
			...
			IntellectBase: 55, IntellectFlux: 8, ResistBase: 60, ResistFlux: 8,
		...
		},
		{
			...
			IntellectBase: 60, IntellectFlux: 8, ResistBase: 65, ResistFlux: 8,
