...
func seedEquipment(db *gorm.DB) error {
	weapons := []models.WeaponDef{
		...
		{ID: "pistol_glock", Name: "G17手枪", Category: "pistol", Hit: 68, Damage: 22, Penetration: 18, Suppress: 12, Ready: 12, AmmoPerRound: 1, Noise: 25, Reliability: 95, CloseMod: 5, MidMod: 0, FarMod: -25, Price: 800, Weight: 3, Slots: 1, MerchantCategory: "weapon"},
		{ID: "smg_mp5", Name: "MP5冲锋枪", Category: "smg", Hit: 62, Damage: 28, Penetration: 20, Suppress: 38, Ready: 8, AmmoPerRound: 4, Noise: 60, Reliability: 90, CloseMod: 12, MidMod: 0, FarMod: -25, Price: 2200, Weight: 6, Slots: 2, MerchantCategory: "weapon", RepRequirement: 10},
		{ID: "shotgun_m870", Name: "M870霰弹枪", Category: "shotgun", Hit: 66, Damage: 40, Penetration: 24, Suppress: 42, Ready: 0, AmmoPerRound: 1, Noise: 75, Reliability: 92, CloseMod: 18, MidMod: -15, FarMod: -100, Price: 1800, Weight: 7, Slots: 2, MerchantCategory: "weapon"},
		{ID: "rifle_ak", Name: "AK突击步枪", Category: "rifle", Hit: 68, Damage: 32, Penetration: 40, Suppress: 34, Ready: 0, AmmoPerRound: 3, Noise: 70, Reliability: 88, CloseMod: -5, MidMod: 10, FarMod: -8, Price: 3000, Weight: 8, Slots: 2, MerchantCategory: "weapon"},
		{ID: "sniper_m24", Name: "M24狙击枪", Category: "sniper", Hit: 75, Damage: 50, Penetration: 58, Suppress: 25, Ready: -12, AmmoPerRound: 1, Noise: 85, Reliability: 85, CloseMod: -30, MidMod: 0, FarMod: 18, Price: 4500, Weight: 10, Slots: 3, MerchantCategory: "weapon", RepRequirement: 30},
	}
	...
	armors := []models.ArmorDef{
		{ID: "light_01", Name: "轻型防弹衣", Type: "light", Protect: 18, Coverage: 55, Mobility: 8, Initiative: 5, Conceal: 8, AntiSuppress: 0, Escape: 10, MaxDurability: 100, Price: 1200, Weight: 5, Slots: 2, MerchantCategory: "clothing"},
		{ID: "light_02", Name: "侦察轻甲", Type: "light", Protect: 14, Coverage: 45, Mobility: 12, Initiative: 8, Conceal: 12, AntiSuppress: 2, Escape: 14, MaxDurability: 80, Price: 1000, Weight: 4, Slots: 2, MerchantCategory: "clothing"},
		{ID: "heavy_01", Name: "重型防弹甲", Type: "heavy", Protect: 42, Coverage: 85, Mobility: -10, Initiative: -8, Conceal: -12, AntiSuppress: 10, Escape: -15, MaxDurability: 150, Price: 2800, Weight: 14, Slots: 3, MerchantCategory: "clothing"},
		{ID: "heavy_02", Name: "战术重甲", Type: "heavy", Protect: 38, Coverage: 80, Mobility: -6, Initiative: -5, Conceal: -8, AntiSuppress: 8, Escape: -10, MaxDurability: 130, Price: 2400, Weight: 12, Slots: 3, MerchantCategory: "clothing", RepRequirement: 30},
	}
	...
	owned := []models.Inventory{
		{ItemID: "rifle_ak", Name: "AK突击步枪", Kind: "weapon", Quantity: 1, Price: 3000, Weight: 8, Slots: 2},
		{ItemID: "light_01", Name: "轻型防弹衣", Kind: "armor", Quantity: 1, Price: 1200, Weight: 5, Slots: 2},
		{ItemID: "heavy_01", Name: "重型防弹甲", Kind: "armor", Quantity: 1, Price: 2800, Weight: 14, Slots: 3},
		{ItemID: "chestrig_01", Name: "轻型胸挂", Kind: "chestrig", Quantity: 1, Price: 400, Weight: 1, Slots: 1},
		{ItemID: "backpack_01", Name: "登山背包", Kind: "backpack", Quantity: 1, Price: 600, Weight: 2, Slots: 2},
		{ItemID: "helmet_01", Name: "轻型头盔", Kind: "helmet", Quantity: 1, Price: 700, Weight: 2, Slots: 1},
		{ItemID: "headset_01", Name: "基础战术耳机", Kind: "headset", Quantity: 1, Price: 500, Weight: 1, Slots: 1},
	}
