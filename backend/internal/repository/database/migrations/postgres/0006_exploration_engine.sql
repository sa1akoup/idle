...
ALTER TABLE sessions ADD COLUMN offline_limit_sec BIGINT NOT NULL DEFAULT 86400;
ALTER TABLE sessions ADD COLUMN elapsed_sec BIGINT NOT NULL DEFAULT 0;
ALTER TABLE sessions ADD COLUMN next_run_at TIMESTAMPTZ;
ALTER TABLE sessions ADD COLUMN current_run_started_at TIMESTAMPTZ;
ALTER TABLE sessions ADD COLUMN last_processed_at TIMESTAMPTZ;
ALTER TABLE sessions ADD COLUMN lease_owner TEXT NOT NULL DEFAULT '';
ALTER TABLE sessions ADD COLUMN lease_until TIMESTAMPTZ;
ALTER TABLE sessions ADD COLUMN heartbeat_at TIMESTAMPTZ;
...
ALTER TABLE session_runs ADD COLUMN duration_sec BIGINT NOT NULL DEFAULT 0;
